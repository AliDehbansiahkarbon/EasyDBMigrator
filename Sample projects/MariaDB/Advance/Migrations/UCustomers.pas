...
begin
  try
    MySQL.ExecuteAdHocQuery('Drop Table TbCustomers');
...
begin
  try
    MySQL.ExecuteAdHocQuery('Alter table TbCustomers Drop Column Phone');
  except on E: Exception do
    Logger.Log(atDownGrade, E.Message, AttribEntityName, AttribVersion);
  end;
end;
...
begin
  try
    MySQL.ExecuteAdHocQuery('Alter table TbCustomers Add Phone Varchar(10)');
  except on E: Exception do
    Logger.Log(atUpgrade, E.Message, AttribEntityName, AttribVersion);
  end;
end;
