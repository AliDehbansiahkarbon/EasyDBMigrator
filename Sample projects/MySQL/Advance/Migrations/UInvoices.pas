...
begin
  try
    MySQL.ExecuteAdHocQuery('Drop Table TbInvoices');
...
begin
  try
    MySQL.ExecuteAdHocQuery('Alter table TbInvoices Drop Column TotlaAmount');
  except on E: Exception do
    Logger.Log(atDownGrade, E.Message, AttribEntityName, AttribVersion);
  end;
end;
...
begin
  try
    MySQL.ExecuteAdHocQuery('Alter table TbInvoices Add TotlaAmount Decimal(10, 2)');
  except on E: Exception do
    Logger.Log(atUpgrade, E.Message, AttribEntityName, AttribVersion);
  end;
end;
