...
begin
  ...
  procedure
  begin
    with TORM.GetInstance(ttSQLServer) do
    begin
  ...
  procedure
  begin
    TORM.GetInstance(ttSQLServer).Delete.Table('TbUsers');
    TORM.GetInstance(ttSQLServer).SubmitChanges;
  end
  ));
  //============================================
  ...
  procedure
  begin
    TORM.GetInstance(ttSQLServer).Alter.Table('TbUsers').AddColumn('NewField2').AsVarchar(50).Nullable;
    TORM.GetInstance(ttSQLServer).SubmitChanges;
  end,
  procedure
  begin
    TORM.GetInstance(ttSQLServer).Alter.Table('TbUsers').DropColumn('NewField2');
    TORM.GetInstance(ttSQLServer).SubmitChanges;
  end
  ));
  //============================================
  ...
  procedure
  begin
    TORM.GetInstance(ttSQLServer).Alter.Table('TbUsers').AddColumn('NewField3').AsInt.Nullable;
    TORM.GetInstance(ttSQLServer).SubmitChanges;
  end,
  procedure
  begin
  ...
  procedure
  begin
    TORM.GetInstance(ttSQLServer).Delete.Table('TbCustomers');
    TORM.GetInstance(ttSQLServer).SubmitChanges;
  end
  ));
end;
